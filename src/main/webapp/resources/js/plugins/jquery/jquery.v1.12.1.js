...
!function (a, b) {
    ...
    var c = [], d = a.document, e = c.slice, f = c.concat, g = c.push,
        h = c.indexOf, i = {}, j = i.toString, k = i.hasOwnProperty, l = {},
        m = "1.12.1", n = function (a, b) {
    ...
    var t = function (a) {
        var b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t,
            u = "sizzle" + 1 * new Date, v = a.document, w = 0, x = 0, y = ga(),
            z = ga(), A = ga(), B = function (a, b) {
                return a === b && (l = !0), 0
            ...
            S = new RegExp("^" + L + "*([>+~]|" + L + ")" + L + "*"),
            T = new RegExp("=" + L + "*([^\\]'\"]*?)" + L + "*\\]", "g"),
            U = new RegExp(O), V = new RegExp("^" + M + "$"), W = {
                ID: new RegExp("^#(" + M + ")"),
                CLASS: new RegExp("^\\.(" + M + ")"),
                TAG: new RegExp("^(" + M + "|[*])"),
                ATTR: new RegExp("^" + N),
            ...
            }, X = /^(?:input|select|textarea|button)$/i, Y = /^h\d$/i,
            Z = /^[^{]+\{\s*\[native \w/,
            $ = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, _ = /[+~]/, aa = /'|\\/g,
        ...
        c = fa.support = {}, f = fa.isXML = function (a) {
            ...
            return g !== n && 9 === g.nodeType && g.documentElement ? (n = g, o = n.documentElement, p = !f(n), (e = n.defaultView) && e.top !== e && (e.addEventListener ? e.addEventListener("unload", da, !1) : e.attachEvent && e.attachEvent("onunload", da)), c.attributes = ia(function (a) {
                ...
                if (a === b)return l = !0, 0;
                var c, d = 0, e = a.parentNode, f = b.parentNode, g = [a],
                    h = [b];
    ...
    var u = function (a, b, c) {
            ...
            return c
        }, w = n.expr.match.needsContext, x = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/,
        y = /^.[^:#\[\.,]*$/;
    ...
    function R(a, b, d, e) {
        if (M(a)) {
            var f, g, h = n.expando, i = a.nodeType, j = i ? n.cache : a,
                k = i ? a[h] : a[h] && h;
    ...
    function S(a, b, c) {
        if (M(a)) {
            var d, e, f = a.nodeType, g = f ? n.cache : a,
    ...
    var Y = function (a, b, c, d, e, f, g) {
        ...
        }, Z = /^(?:checkbox|radio)$/i, $ = /<([\w:-]+)/,
        _ = /^$|\/(?:java|ecma)script/i, aa = /^\s+/,
    ...
    var ta = / jQuery\d+="(?:null|\d+)"/g,
        ...
        wa = /<script|<style|<link/i, xa = /checked\s*(?:[^=]|=\s*.checked.)/i,
        ya = /^true\/(.*)/, za = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
    ...
    function Ha(a, b, c, d) {
        b = f.apply([], b);
        var e, g, h, i, j, k, m = 0, o = a.length, p = o - 1, q = b[0],
            r = n.isFunction(q);
    ...
    var Va = /alpha\([^)]*\)/i, Wa = /opacity\s*=\s*([^)]*)/i,
        Xa = /^(none|table(?!-c[ea]).+)/,
        Ya = new RegExp("^(" + T + ")(.*)$", "i"),
    ...
    function fb(b, c, e) {
        var f = !0, g = "width" === c ? b.offsetWidth : b.offsetHeight,
            h = Ra(b),
    ...
    function ob(a, b, c) {
        var d, e, f, g, h, i, j, k, m = this, o = {}, p = a.style,
            q = a.nodeType && W(a), r = n._data(a, "fxshow");
    ...
    function qb(a, b, c) {
        var d, e, f = 0, g = qb.prefilters.length,
    ...
    n.Animation = n.extend(qb, {
        ...
        fadeTo: function (a, b, c, d) {
            ...
            return a !== !1 && (a = a || "fx"), this.each(function () {
                var b, c = n._data(this), d = c[a + "queue"],
    ...
    var sb, tb, ub = n.expr.attrHandle, vb = /^(?:checked|selected)$/i,
        wb = l.getSetAttribute, xb = l.input;
    n.fn.extend({
        attr: function (a, b) {
    ...
    n.extend({
        ...
        ajax: function (b, c) {
            ...
            var d, e, f, g, h, i, j, k, l = n.ajaxSetup({}, c),
                ...
                p = n.Deferred(), q = n.Callbacks("once memory"),
                r = l.statusCode || {}, s = {}, t = {}, u = 0, v = "canceled",
                w = {
    ...
    n.offset = {
        ...
        offset: function (a) {
            ...
            var b, c, d = {top: 0, left: 0}, e = this[0],
                f = e && e.ownerDocument;
